...
var SekindoClientDetections_URL = function (config) {
	...
	if (this.isPlayerApiActions && !this.isAmpProject && !this.isAmpIframe && !this.isApp) this.playerApiActions();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=112981&cbuster=1675659673&pubUrl=https://emojipedia.org/star/&x=700&y=476&playerApiId=freestarPrimisPlayer&schain=1.0,1!freestar.com,1382,1&cbuster=1675660292',
					origQString: 's=112981&cbuster=1675659673&pubUrl=https://emojipedia.org/star/&x=700&y=476&playerApiId=freestarPrimisPlayer&schain=1.0,1!freestar.com,1382,1',
					placementId: 112981,
					x: 700,
					y: 476,
					videoType: 'normal',
